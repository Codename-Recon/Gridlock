...
var lobby_element_scene: PackedScene = preload("res://logic/scenes/ui/lobby_selection_element.tscn")
...
func _on_visibility_changed() -> void:
	if visible:
		var _res: Error = await _multiplayer.nakama_login()
		if _res > OK:
			_messages.spawn(tr("MESSAGE_TITLE_LOBBY_CONNECTION_PROBLEM"), tr("MESSAGE_TEXT_LOBBY_CONNECTION_PROBLEM"), true)
